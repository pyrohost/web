		...
		<TooltipProvider>
			<div className="flex flex-col gap-2">
				...
				<Tooltip delayDuration={0}>
					<TooltipTrigger>
						<div className="select-none flex max-h-[36px] min-h-[36px] w-full items-center justify-center gap-2 overflow-hidden rounded-lg bg-[#ffffff17] px-4 py-2 font-bold text-sm outline-none transition opacity-60">
							<svg className="h-5 w-5" xmlns="http://www.w3.org/2000/svg" width="512" height="514" viewBox="0 0 512 514" data-v-95883ab0="">
								<path
									fill="currentColor"
									fill-rule="evenodd"
							...
							Continue with Modrinth
						</div>
					</TooltipTrigger>

					<TooltipContent>Coming soon! We&apos;re working on it.</TooltipContent>
				</Tooltip>
				{/* </form> */}
