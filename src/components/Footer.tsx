...
const Footer = () => {
    return (
        <footer className='sticky bottom-0 flex w-full flex-col justify-between gap-12 rounded-t-3xl px-4 py-7 text-white md:flex-col md:gap-x-12 md:px-10 lg:flex-row'>
