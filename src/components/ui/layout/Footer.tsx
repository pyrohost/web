		...
		<>
			{AUTHENTICATED_ROUTES.some((route) => pathname.includes(route)) ? (
				<div className="border-t-[#ffffff16] border-t-[1px] bg-[#ffffff07]">
					<footer className="container sticky bottom-0 flex w-full flex-wrap items-center justify-center gap-4 px-8 py-8 text-[#999] md:justify-between">
						...
						<Link href="/legal/privacy" className="text-[#999] text-xs transition hover:text-[#fff]">
							Privacy
						</Link>
						<Link href="https://status.pyro.host" className="text-[#999] text-xs transition hover:text-[#fff]">
							Status
						</Link>
						<Link href="/legal/cookies" className="text-[#999] text-xs transition hover:text-[#fff]">
							Cookies
						</Link>
					</footer>
				</div>
				...
				<footer className="container sticky bottom-0 flex w-full flex-col justify-between gap-12 rounded-t-3xl px-8 py-7 sm:flex-row md:gap-x-12">
					...
					<div className="flex flex-row items-center justify-center gap-8">
						<Link aria-label="Follow Pyro on X (Formerly Twitter)" rel="noopener noreferrer" target="_blank" href="https://x.com/withPyro">
						...
						<Link aria-label="Follow Pyro on GitHub" rel="noopener noreferrer" target="_blank" href="https://github.com/pyrohost">
						...
						<Link aria-label="Join the Pyro Discord community" rel="noopener noreferrer" target="_blank" href="/discord">
