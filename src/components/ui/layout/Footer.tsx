			...
			{AUTHENTICATED_ROUTES.some((route) => pathname.includes(route)) ? (
				...
				<footer className="container sticky bottom-0 flex w-full flex-col justify-between gap-12 rounded-t-3xl px-8 py-7 sm:flex-row md:gap-x-12">
					...
					<div className="flex flex-row items-center justify-center gap-8">
						<a aria-label="Follow Pyro on X (Formerly Twitter)" rel="noopener noreferrer" target="_blank" href="https://x.com/withPyro">
						...
						<a aria-label="Follow Pyro on GitHub" rel="noopener noreferrer" target="_blank" href="https://github.com/pyrohost">
