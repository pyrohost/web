	...
	({ className, children, ...props }, ref) => (
		<DrawerPortal>
			...
			<DrawerPrimitive.Content
				ref={ref}
				className={cn("fixed inset-x-0 bottom-0 z-50 mt-24 flex h-auto flex-col rounded-t-[10px] bg-[#ffffff22] backdrop-blur-2xl", className)}
				{...props}
			>
				<div className="mx-auto mt-4 h-1.5 w-[32px] rounded-full bg-[#ffffff55]" />
				{children}
			</DrawerPrimitive.Content>
		</DrawerPortal>
	),
