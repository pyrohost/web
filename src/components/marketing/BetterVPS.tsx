	...
	return (
		<section className="relative z-10 w-full overflow-clip rounded-3xl rounded-t-none bg-gradient-to-b from-black to-[#121212]">
			...
			>
				...
				<div className="pointer-events-none absolute top-[0] right-auto left-0 z-[0] h-[676px] w-[676px] scale-[1.75] rounded-full bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[--circle-background] to-70% to-[transparent] opacity-[12%] xl:right-[50px] xl:left-auto" />
					...
					<div className="relative z-[14] grid w-full grid-flow-row gap-3 xl:gap-5">
						<div className="relative grid place-items-center overflow-hidden rounded-[32px] border-2 border-white/10 p-4 lg:p-4 2xl:px-6 xl:px-auto 2xl:py-6 sm:py-6">
							<div className="flex h-full flex-col items-center text-center">
								<Image src="/img/bandwidth_hero.png" width={576} height={400} alt="" className="relative mb-8 w-full opacity-75" />
								<div className="mt-auto mb-2 font-bold text-2xl tracking-tight">Unlimited bandwidth. No overages, zero throttling</div>
							</div>
						</div>
					</div>
					<div className="relative z-[14] grid w-full grid-flow-row gap-3 xl:gap-5">
						<div className="relative grid place-items-center overflow-hidden rounded-[32px] border-2 border-white/10 p-4 lg:p-4 2xl:px-6 xl:px-auto 2xl:py-6 sm:py-6">
							<div className="flex h-full flex-col items-center text-center">
								<Image src="/img/shell_hero.png" width={576} height={400} alt="" className="relative mb-8 w-full opacity-75" />
								<div className="mt-auto mb-2 font-bold text-2xl tracking-tight">Full access to your hardware. Use all of your favorite tools</div>
							</div>
						</div>
					</div>
					<div className="relative z-[14] grid w-full grid-flow-row gap-3 xl:gap-5">
						<div className="relative grid w-full place-items-center overflow-hidden rounded-[32px] bg-brand/20 p-4 text-center lg:p-4 2xl:px-6 xl:px-auto 2xl:py-6 sm:py-6">
							<div className="flex flex-col items-center">
								<Image src="/img/power_hero.png" width={576} height={400} alt="" className="relative mb-8" />
								<div className="mt-auto mb-2 font-bold text-2xl text-brand tracking-tight">Incredible uptime and performance, powered by Pyro</div>
							</div>
						</div>
					</div>
				</div>
