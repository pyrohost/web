	...
	return (
		<section className="relative z-10 flex flex-col items-center gap-8 px-4 py-32 text-center  xl:px-24">
			...
			<div className="lg relative z-10 max-w-[600px] text-[16px] leading-[190%]">
				Pyro is the only hosting company that publicly shares its core source
				code. We&apos;re transparent about how we operate, we iterate in
				coordination with our community, and we&apos;re always open to
				contributions.
			</div>
			<PyroButton
				leftChildren={
