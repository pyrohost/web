		...
		<section className="relative z-10 w-full overflow-clip rounded-3xl rounded-t-none bg-gradient-to-b from-[#000000] to-[#121212]">
			<div className="container relative grid gap-12 pt-24 pb-20 lg:gap-20 lg:py-40">
				<div className="relative z-[14] flex max-w-[600px] flex-col items-start justify-start">
					...
					<h1 className="mb-6 max-w-4xl font-extrabold text-[max(48px,min(5vw,90px))] text-white leading-[1.09] tracking-tighter">
					...
					<PyroButton variant="quaternary" href="/pyrodactyl/">
						Learn more
					</PyroButton>
				</div>
