    ...
    <>
      <div className="flex h-[700px] w-full flex-col gap-8 rounded-3xl bg-[#d6b4ba0f] p-8 backdrop-blur-lg">
        ...
        <p className="flex">
          ...
          <span className="ml-1.5 text-5xl font-black text-white">$4</span>
          <span className="ml-2 self-center text-sm text-[#ffffff99]">
            per month
          </span>
        </p>
        <div className="text-md flex flex-col gap-4 font-bold">
      ...
      <div className="flex h-[700px] w-full flex-col gap-8 rounded-3xl bg-[#d6b4ba0f] p-8 backdrop-blur-lg">
        ...
        <h2 className="text-left text-[#ffffff99]">
          Everything you need to get started, quickly. Perfect for playing solo
          or with a small group of friends. Supports your favorite modpacks.
        </h2>
        <p className="flex">
          <span className="text-[12px] font-medium text-white">US</span>
          <span className="ml-1.5 text-5xl font-black text-white">$8</span>
          <span className="ml-2 self-center text-sm text-[#ffffff99]">
            per month
          </span>
        </p>
        ...
        <div
          ...
          className="pointer-events-none mt-auto flex items-center justify-center gap-4 rounded-full py-3 pl-8 pr-6 text-sm font-bold opacity-50"
        >
          <p>Out of stock</p>
        </div>
      </div>
      ...
      <div className="flex h-[700px] w-full flex-col gap-8 rounded-3xl bg-[#d6b4ba0f] p-8 backdrop-blur-lg">
        ...
        <h2 className="text-left text-[#ffffff99]">
          Powerful features for the most demanding modpacks, large communities,
          and players desiring a premium, lag-free experience.
        </h2>
        <p className="flex">
          <span className="text-[12px] font-medium text-white">US</span>
          <span className="ml-1.5 text-5xl font-black text-white">$16</span>
          <span className="ml-2 self-center text-sm text-[#ffffff99]">
            per month
          </span>
        </p>
