...
const Page = () => {
    return (
        <main className='relative h-full w-full'>
                ...
                <div className='relative mt-24 flex w-full max-w-[1200px] flex-col text-left'>
                    <div className='grid grid-rows-2 place-items-start justify-items-center gap-9 sm:grid-cols-3'>
                        <div className='inline max-w-[256px] font-medium text-[#888]'>
                            <HugeIconsSupport className='-mt-1.5 mr-1 inline !h-5 !w-5 fill-white' fill='regular' />
                            <h4 className='inline leading-[170%]'>
                                <span className='inline text-white'>Top-tier support.</span> Tickets and a dedicated
                                team for every customer.
                            </h4>
                        </div>
                        <div className='inline max-w-[256px] font-medium text-[#888]'>
                        ...
                        <div className='inline max-w-[256px] font-medium text-[#888]'>
                            <HugeIconsStorage className='-mt-1.5 mr-1 inline !h-5 !w-5 fill-white' fill='regular' />
                            <h4 className='inline leading-[170%]'>
                                <span className='inline text-white'>Boundless storage.</span> Store all your files,
                                worlds, and backups, with no limits.
                            </h4>
                        </div>
                        <div className='inline max-w-[256px] font-medium text-[#888]'>
                        ...
                        <div className='inline max-w-[256px] font-medium text-[#888]'>
                            <HugeIconsLink className='-mt-1.5 mr-1 inline !h-5 !w-5 fill-white' fill='regular' />
                            <h4 className='inline leading-[170%]'>
                                <span className='inline text-white'>Subdomains.</span> Create a recognizable pyro.host
                                subdomain, for free.
                            </h4>
                        </div>
                        <div className='inline max-w-[256px] font-medium text-[#888]'>
                    ...
                    <div className='mt-24 flex flex-col gap-16 xl:flex-row'>
                        <div className='flex w-full flex-col overflow-hidden rounded-3xl border-2 border-[#ffffff11] p-8 backdrop-blur-3xl md:min-h-[400px]'>
                            ...
                            <p className='z-10 mt-4 max-w-lg opacity-60'>
                                All Pyro servers come with Overflow Memory, allowing your server to use more memory when
                                you need it most. Your server comes with both high-speed RAM and NVME-based memory,
                                available when you need it, at no extra cost.
                            </p>
                    ...
                    <div className='mt-8 flex flex-col gap-8 xl:flex-row'>
                        <div className='flex w-full flex-col rounded-3xl border-2 border-[#ffffff11] bg-[#ffffff11] p-8'>
                            <h2 className='text-2xl font-bold'>Any server type, any mod, all on Pyro</h2>
                            <p className='mt-4 opacity-60'>
                                Pyro supports all server types, all mods, and all plugins. If you can run it on a
                                server, you can run it on Pyro. Everything from Spigot to Forge, Paper to Fabric, Bukkit
                                to BungeeCord, and everything in between. Play your favorite mods, like Feed The Beast
                                and ATLauncher.
                            </p>
                        </div>
                        <div className='flex w-full flex-col rounded-3xl border-2 border-[#ffffff11] bg-[#ffffff11] p-8'>
                            <h2 className='text-2xl font-bold'>Transfer your world, or start fresh</h2>
                            <p className='mt-4 opacity-60'>
                                Pyro makes it easy to transfer your world, your plugins, and your mods, from any other
                                host. Or, start fresh with a new world and new plugins. Pyro makes it easy to get
                                started, and easy to switch. And, with our 24/7 support, you&apos;ll never be alone in
                                the process.
                            </p>
                        </div>
                    </div>
            ...
            <Section>
                <div className='z-20'>
                    <Section.Title maxWidth={800}>It&apos;s where your world plays</Section.Title>
                    <Section.Description maxWidth={800}>
                        Our servers are currently in Europe and we&apos;re rapidly expanding to more locations. But no
