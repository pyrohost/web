	...
	return (
		<>
			<section className="relative mx-auto flex flex-col items-center gap-8 overflow-clip px-4 py-32 pb-64 text-center xl:px-24">
				<div className="-mb-8">
					<div className="flex h-8 cursor-default select-none items-center gap-[6px] rounded-full border border-neutral-900/30 px-[11px] py-[4px]">
						<div className="font-medium text-15">About Us</div>
					</div>
				</div>
				<h1 className="max-w-4xl py-4 pt-5 pb-3 font-extrabold text-[max(40px,min(5vw,90px))] leading-[1.09] tracking-tighter lg:pb-5">
				...
				<div className="relative w-full max-w-[80ch]">
					<div className="flex w-full flex-col gap-8">
						<p className="text-xl leading-[190%] opacity-50">
							Pyro is an atypically talented, globally distributed team of engineers, designers, and strategists building open-source hosting infrastructure. We
							are on a mission to make hosting accessible to everyone, and we&apos;re building the ecosystem of tools and services to make that possible.
						</p>
					</div>
				</div>
			</section>
			...
			<section className="relative z-10 flex flex-col items-center gap-8 overflow-hidden rounded-b-3xl px-4 py-48 text-center xl:px-24">
				...
				<p className="relative max-w-2xl text-[#ffffff99] text-xl leading-[195%]">
					We&apos;re always looking for talented individuals to join our team. If you&apos;re passionate about open-source and want to help us build the future
					of hosting, we&apos;d love to hear from you.
				</p>
				<PyroButton
					leftChildren={
