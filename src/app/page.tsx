            ...
            <section className='relative z-10 w-full overflow-clip rounded-3xl rounded-t-none bg-gradient-to-b from-[#000000] to-[#121212] '>
                <div className='container relative grid gap-12 pb-20 pt-24 lg:gap-20 lg:py-40'>
                    <div className='relative z-[14] flex max-w-[600px] flex-col items-start justify-start'>
                        ...
                        <PyroButton color={'black'} type={'outlineLight'} href='/pyrodactyl/'>
                            Learn more
                        </PyroButton>
                    </div>
                ...
                <div className='flex w-full flex-col gap-8 text-left md:flex-row'>
                    <Link className='contents' href='https://pyro.host/discord'>
                        <div className='flex w-full flex-col gap-4 rounded-2xl bg-[#ffffff14] p-8'>
                            <div className='flex flex-row items-center gap-6 text-3xl font-bold'>
                            ...
                            <p className='text-lg'>
                                Join our Discord server to chat with fellow Pyro users, get support, and stay up to date
                    ...
                    <Link className='contents' href='https://x.com/withpyro'>
                        <div className='flex w-full flex-col gap-4 rounded-2xl bg-[#ffffff14] p-8'>
                            ...
                            <p className='text-lg'>
                                Follow us on Twitter to stay up to date with the latest news, updates, and
                                announcements.
                            </p>
                            <div className='flex flex-row items-center gap-4 font-bold text-brand'>
                                Follow
