        ...
        <Section>
          <div className="z-20">
            ...
            <Section.Description maxWidth={800}>
              Our servers are currently in Europe and we&apos;re rapidly
              expanding to more locations. But no matter where you are, we
              strive for the best playing experience for you and your players.
            </Section.Description>
