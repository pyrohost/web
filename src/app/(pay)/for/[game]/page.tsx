		...
		<>
			...
			<section className="container relative flex flex-col items-center py-32 pt-24">
				<div className="flex flex-col items-center gap-8 text-center">
					<h1 className="font-extrabold text-[max(48px,min(5vw,72px))] leading-[1.09] tracking-tighter">{game.name} Hosting</h1>
					<p className="max-w-3xl font-medium text-[#ffffff99] text-xl leading-[190%]">
						With Pyro, you can host your own {game.name} server with ease. Whether you&apos;re playing with friends or running a public server, we&apos;ve got a
						plan for you.
					</p>
				</div>
				...
				<div className="container relative grid gap-12 pt-24 pb-20 lg:gap-20 lg:py-40">
					<div className="relative z-[14] flex flex-col items-start justify-start">
						...
						<h2 className="mx-auto mb-12 max-w-4xl text-center font-medium text-[#ffffff99] text-xl leading-[190%]">
							All Pyro plans are fully-featured and come with everything you need to run a successful {game.name} server. You get the same great features no
				...
				<div className="container relative grid gap-4 pt-24 pb-20 lg:gap-12 lg:py-40">
					...
					<Accordion className="mx-auto w-full max-w-3xl text-left" type="multiple">
						<AccordionItem className="text-left" value="modsplugins">
							<AccordionTrigger className="text-left">Can I add plugins and mods to my {game.name} server?</AccordionTrigger>
							<AccordionContent>Yes! You can add any plugins or mods you want to your server. If it runs on {game.name}, it runs on Pyro.</AccordionContent>
						</AccordionItem>

						<AccordionItem className="text-left" value="support">
							<AccordionTrigger className="text-left">How do I get support for my server?</AccordionTrigger>
							<AccordionContent>
								We offer support over Discord. If you have any questions or need help with your server, just ask. You&apos;ll get a dedicated channel that
								always stays open for the duration of your plan.
							</AccordionContent>
						</AccordionItem>
