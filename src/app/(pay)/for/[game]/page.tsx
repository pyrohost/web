			...
			<section className="container relative flex flex-col items-center py-32 pt-24">
				<div className="flex flex-col items-center gap-8 text-center">
					...
					<p className="max-w-3xl text-xl font-medium leading-[190%] text-[#ffffff99]">
						With Pyro, you can host your own {game.name} server with ease.
						Whether you&apos;re playing with friends or running a public server,
				...
				<div className="container relative grid gap-12 pb-20 pt-24 lg:gap-20 lg:py-40">
					<div className="relative z-[14] flex flex-col items-start justify-start">
						...
						<h2 className="mx-auto mb-12 max-w-4xl text-center text-xl font-medium leading-[190%] text-[#ffffff99]">
							...
							need to run a successful {game.name} server. You get the same
							great features no matter which plan you choose.
						</h2>
				...
				<div className="container relative grid gap-4 pb-20 pt-24 lg:gap-12 lg:py-40">
					...
					>
						<AccordionItem className="text-left" value="modsplugins">
							...
							<AccordionContent>
								Yes! You can add any plugins or mods you want to your server. If
								it runs on {game.name}, it runs on Pyro.
							</AccordionContent>
						</AccordionItem>
						...
						<AccordionItem className="text-left" value="support">
							...
							<AccordionContent>
								We offer support over Discord. If you have any questions or need
								help with your server, just ask. You&apos;ll get a dedicated
								channel that always stays open for the duration of your plan.
							</AccordionContent>
						</AccordionItem>
