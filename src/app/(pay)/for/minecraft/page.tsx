...
const Checkmark = ({ brand }: { brand?: boolean }) => (
	<svg
		...
		fill="none"
		viewBox="0 0 18 18"
		className="absolute top-[2px] left-0 h-4 w-4"
		aria-hidden="true"
	>
		<path
		...
		<>
			...
			<section className="container relative flex flex-col items-center py-32 pt-24">
				<div className="flex flex-col items-center gap-8 text-center">
					<h1 className="font-extrabold text-[max(48px,min(5vw,72px))] leading-[1.09] tracking-tighter">Minecraft Hosting</h1>
					<p className="max-w-3xl font-medium text-[#ffffff99] text-xl leading-[190%]">
						With Pyro, you can host your own Minecraft server with ease. Whether you&apos;re playing with friends or running a public server, we&apos;ve got a
						plan for you.
					</p>
				</div>
				<div className="relative mx-auto mt-20 w-full md:mt-9 xl:mt-12 lg:w-full">
					<h2 className="sr-only">Pyro pricing plans</h2>
					<ul className="grid-gap relative z-10 grid grid-cols-1 gap-x-6 gap-y-4 lg:grid-cols-2 xl:grid-cols-4 lg:gap-y-4 md:gap-y-6">
						{plans.map((plan) => (
							<li
								className={clsx("group relative flex min-h-full flex-col rounded-xl bg-[#ffffff15] px-8 pt-5 pb-10 sm:p-5 xl:px-6 xl:py-5", {
									"border-[1px] border-brand": plan.slug === "friends",
									"border border-transparent": plan.slug !== "friends",
								})}
								key={plan.slug}
							>
								<div className="mb-6 flex flex-col border-white/20 border-b border-dashed pb-5 xl:mb-5">
									<h3
										className={clsx("font-medium text-xl leading-none tracking-tight xl:text-lg", {
											"text-brand": plan.slug === "friends",
										})}
									>
										{plan.name}

										{plan.slug === "friends" && <span className="ml-2 rounded-full bg-brand px-2 py-1 font-bold text-white text-xs">Recommended</span>}
									</h3>

									<p className="relative mt-14 font-bold text-[36px] leading-none tracking-tighter md:mt-4 xl:mt-9 xl:text-[32px]">
										${plan.price} <span className="font-normal text-[#ffffff99] text-[20px] tracking-normal">/month</span>
									</p>
									<Link
										className={clsx(
									...
									<p className="mt-9 font-light leading-snug xl:mt-8 lg:min-h-max">{getPlanDescription(plan.slug)}</p>
								</div>
					...
					<p className="mx-auto mt-12 max-w-3xl text-center font-medium text-[#ffffff99] text-xl leading-[190%]">
			...
			<section id="recommended" className="relative z-10 w-full overflow-clip rounded-3xl rounded-t-none bg-gradient-to-b from-[#000000] to-[#121212]">
				<div className="container relative grid gap-12 pt-24 pb-20 lg:gap-20 lg:py-40">
					<div className="relative z-[14] flex flex-col items-start justify-start">
						<h1 className="mx-auto mb-6 font-extrabold text-[max(48px,min(5vw,64px))] text-white leading-[1.09] tracking-tighter">
							<div className="flex flex-row items-center gap-4">Why Pyro is right for you</div>
						</h1>

						<h2 className="mx-auto mb-12 max-w-4xl text-center font-medium text-[#ffffff99] text-xl leading-[190%]">
							All Pyro plans are fully-featured and come with everything you need to run a successful Minecraft server. You get the same great features no
						...
						<div className="mb-8 flex w-full flex-col items-center gap-8 md:flex-row">
							<div className="relative flex min-h-[450px] w-full flex-col gap-4 overflow-hidden rounded-3xl bg-[#232323] p-8 text-center">
								<Image aria-hidden src="/img/unlimitedplayers_final.png" fill alt="" quality={100} className="pointer-events-none select-none object-cover" />
								<div className="relative mt-auto mb-2 font-bold text-3xl tracking-tight">
									No player limits. Invite as many friends as you want with zero extra charges.
								</div>
							</div>

							<div className="relative flex min-h-[450px] w-full flex-col gap-4 overflow-hidden rounded-3xl bg-[#232323] p-8 text-center">
								<Image aria-hidden src="/img/unlimitedspecs.png" quality={100} fill alt="" className="pointer-events-none select-none object-cover" />
								<div className="relative mt-auto mb-2 font-bold text-3xl tracking-tight">
						...
						<div className="mb-8 flex w-full flex-col items-center gap-8 md:flex-row">
							...
							<div className="relative flex min-h-[450px] w-full flex-col gap-4 overflow-hidden rounded-3xl bg-[#232323] p-8 text-center">
								...
								/>
								<div className="relative mt-auto mb-2 font-bold text-3xl tracking-tight">Works with all your favorite mods and plugins. No restrictions.</div>
							</div>
						</div>

						<div className="flex w-full flex-col items-center">
							<div className="relative flex w-full flex-col gap-4 overflow-hidden rounded-3xl bg-[#232323] p-8">
								<div className="relative mb-2 font-bold text-3xl tracking-tight">A minimum of 2 CPU cores on every plan. Always.</div>
								<div
								...
								>
									Why? Although Minecraft is single-threaded, your mods and plugins will take advantage of multiple cores. Your Pyro server will simply run
									smoother and faster.
								</div>
							</div>
						</div>
			...
			<section className="relative z-10 w-full overflow-clip">
				<div className="container relative grid gap-12 pt-24 pb-20 lg:gap-20 lg:py-40">
					<div className="relative z-[14] flex max-w-[600px] flex-col items-start justify-start">
						<PyroPill leftChild={<Image src="/img/pyrodactylorange.png" width={24} height={24} alt="" className="h-6 w-6" />}>Better Software</PyroPill>
						<h1 className="mb-6 max-w-4xl font-extrabold text-[max(48px,min(5vw,84px))] text-white leading-[1.09] tracking-tighter">
						...
						<p className="mb-6 font-medium text-[#ffffff99] text-xl leading-[190%]">
							With Pyro, you don’t hop through loops to get from paying to playing, it just works better. It’s like a super-app for your server.
						</p>
					</div>
					<div className="relative flex w-full flex-col gap-5 xl:flex-row">
						...
						<div className="relative z-[14] grid w-full grid-flow-row gap-3 xl:w-[45%] xl:gap-5">
							<div className="relative grid place-items-center overflow-hidden rounded-2xl border-2 border-white/10 bg-[#ffffff08] p-4 text-white lg:p-4 2xl:px-6 xl:px-auto 2xl:py-6 sm:py-6">
								<ul className="relative flex flex-col gap-4 lg:gap-8">
									<li className="leading-[190%]">
										<span className="font-bold">Easy. </span>
										<span>Whether you’re a complete beginner or a seasoned pro, Pyro makes it easy to manage your server.</span>
									</li>
									<li className="leading-[190%]">
										<span className="font-bold">Fast. </span>
										<span>Uncompromising speed. Optimal performance. Pyro software is entirely bullet-proof.</span>
									</li>
									<li className="leading-[190%]">
					...
					>
						...
						<p className="mt-4 text-center font-bold text-xs opacity-50">Drag or swipe to see more</p>
					</Carousel>
				</div>
			</section>

			<section className="relative z-10 w-full overflow-clip rounded-3xl rounded-b-none bg-gradient-to-b from-[#121212] to-black">
				<div className="container relative grid gap-4 pt-24 pb-20 lg:gap-12 lg:py-40">
					<h1 className="mx-auto mb-4 font-extrabold text-[max(48px,min(5vw,64px))] text-white leading-[1.09] tracking-tighter">
					...
					<Accordion className="mx-auto w-full max-w-3xl text-left" type="multiple">
						<AccordionItem className="text-left" value="item-1">
							...
							<AccordionContent>
								Yes! You can add plugins and mods to your Minecraft server. You have full control over your server, so you can upload your own mods and plugins,
						...
						<AccordionItem className="text-left" value="item-2">
							...
							<AccordionContent>
								Yes! You can upgrade your server at any time. You can easily upgrade your server by selecting a new plan and paying the difference. Your server
								will be upgraded instantly.
							</AccordionContent>
						</AccordionItem>
						<AccordionItem className="text-left" value="item-3">
							<AccordionTrigger className="text-left">Can I switch between mod loaders? Does Pyro support Fabric, Forge, Neoforge?</AccordionTrigger>
							<AccordionContent>
								Yes! You can switch between games and software at any time. Our panel allows you to easily switch with just a few clicks. And with free backups,
								you can switch back to your old setup at any time.
							</AccordionContent>
						</AccordionItem>
						<AccordionItem className="text-left" value="item-4">
							<AccordionTrigger className="text-left">How much storage do I get with my Minecraft server on Pyro?</AccordionTrigger>
							<AccordionContent>
								You get unlimited storage with your Minecraft server. You can upload as many worlds, mods, and plugins as you want. There are no limits to how
								much storage you can use. You only pay for the RAM you need.
							</AccordionContent>
						</AccordionItem>
						<AccordionItem className="text-left" value="backups">
							...
							<AccordionContent>
								Yes! Pyro offers multiple free backups for all servers. You can create a backup of your server at any time, and restore it in one click. You can
								also schedule backups to run automatically, so you never lose your progress.
							</AccordionContent>
						</AccordionItem>
						<AccordionItem className="text-left" value="offsite">
							<AccordionTrigger className="text-left">Can I store my Pyro backups elsewhere, like Google Drive?</AccordionTrigger>
							<AccordionContent>
								Yes! You can store your backups offsite, like on Google Drive. You can set up automatic backups to run on a schedule. You can also download your
								backups at any time, so you always have a copy of your server.
							</AccordionContent>
						</AccordionItem>
						<AccordionItem className="text-left" value="item-5">
							...
							<AccordionContent>
								No, we do not have player limits. You can invite as many friends as you want to play on your server. There are no extra charges for additional
								players. Ever.
							</AccordionContent>
						</AccordionItem>
						<AccordionItem className="text-left" value="item-6">
							...
							<AccordionContent>
								Yes! You can run a public server with Pyro. You can set up your server to be public or private, using Minecraft&apos;s whitelist system, or a
								plugin that manages it for you. You have full control over your server, so you can customize it to your liking.
							</AccordionContent>
						</AccordionItem>
						<AccordionItem className="text-left" value="item-7">
							...
							<AccordionContent>
								Yes! You can invite others to manage your server. You can create multiple accounts with different permissions, so you can give others access to
								your server without giving them full control. You can also revoke access at any time.
							</AccordionContent>
						</AccordionItem>
						<AccordionItem className="text-left" value="refunds">
							<AccordionTrigger className="text-left">Does Pyro offer refunds if I&apos;m not satisfied?</AccordionTrigger>
							<AccordionContent>
								Yes! We offer a 24-hour money-back guarantee. If you&apos;re not satisfied with your server, you can request a refund within 24 hours of
								purchase. All we ask is that you let us know why you&apos;re not satisfied, so we can improve.
							</AccordionContent>
						</AccordionItem>
					</Accordion>
				</div>
			...
			<section className="relative z-10 flex flex-col items-center gap-8 overflow-hidden rounded-b-3xl px-4 py-48 text-center xl:px-24">
				...
				<div className="img-opacity-animation pointer-events-none absolute inset-0 select-none">
					<div className="pointer-events-none relative inset-0 h-screen min-h-screen w-screen select-none">
						<Image alt="" aria-hidden src="/img/herobackground.svg" fill className="pointer-events-none select-none object-cover opacity-25" />
					</div>
				</div>
				<h1 className="relative max-w-4xl py-4 pt-5 pb-3 font-extrabold text-[max(48px,min(5vw,90px))] leading-[1.09] tracking-tighter lg:pb-5">
					Still have questions?
				</h1>
				<p className="relative text-[#ffffff99] text-xl leading-[195%]">
