	...
	return (
		<>
			...
			<img
				...
				style={{
					maskImage:
						"radial-gradient(585% 120% at 50% 100%, transparent 11.5%, white)",
				}}
			...
			<section className="container relative flex flex-col items-center py-32 pt-24">
				<div className="flex flex-col items-center gap-8 text-center">
					...
					<p className="max-w-3xl text-xl font-medium leading-[190%] text-[#ffffff99]">
						With Pyro, you can host your own Minecraft server with ease. Whether
						you&apos;re playing with friends or running a public server,
					...
					<div className="relative z-[14] flex flex-col items-start justify-start">
						<h1 className="mx-auto mb-6 text-[max(48px,min(5vw,64px))] font-extrabold leading-[1.09] tracking-tighter text-white">
							<div className="flex flex-row items-center gap-4">
								Why Pyro is right for you
							</div>
						</h1>

						<h2 className="mx-auto mb-12 max-w-4xl text-center text-xl font-medium leading-[190%] text-[#ffffff99]">
							All Pyro plans are fully-featured and come with everything you
							need to run a successful Minecraft server. You get the same great
							features no matter which plan you choose.
						</h2>
						...
						<div className="mb-8 flex w-full flex-col items-center gap-8 md:flex-row">
							<div className="relative flex min-h-[450px] w-full flex-col gap-4 overflow-hidden rounded-3xl bg-[#232323] p-8 text-center">
								...
								<div className="relative mb-2 mt-auto text-3xl font-bold tracking-tight">
									No player limits. Invite as many friends as you want with zero
									extra charges.
								</div>
							</div>
							...
							<div className="relative flex min-h-[450px] w-full flex-col gap-4 overflow-hidden rounded-3xl bg-[#232323] p-8 text-center">
								...
								/>
								<div className="relative mb-2 mt-auto text-3xl font-bold tracking-tight">
									Only pay for the RAM you need. Everything else is included on
									Pyro, for free.
								</div>
							</div>
						</div>
						...
						<div className="mb-8 flex w-full flex-col items-center gap-8 md:flex-row">
							<div className="relative flex min-h-[450px] w-full flex-col gap-4 overflow-hidden rounded-3xl bg-[#232323] p-8 text-center">
								<Image
									...
									style={{
										maskImage:
											"radial-gradient(85% 100% at 50% 120%, transparent 55.5%, white)",
									}}
								/>
								<div className="relative mb-2 mt-auto text-3xl font-bold tracking-tight">
									Unlimited storage. Upload as many worlds, mods, and plugins as
									you want.
								</div>
							</div>
							...
							<div className="relative flex min-h-[450px] w-full flex-col gap-4 overflow-hidden rounded-3xl bg-[#232323] p-8 text-center">
								...
								/>
								<div className="relative mb-2 mt-auto text-3xl font-bold tracking-tight">
									Works with all your favorite mods and plugins. No
									restrictions.
								</div>
							</div>
						</div>
						...
						<div className="flex w-full flex-col items-center">
							<div className="relative flex w-full flex-col gap-4 overflow-hidden rounded-3xl bg-[#232323] p-8">
								...
								>
									Why? Although Minecraft is single-threaded, your mods and
									plugins will take advantage of multiple cores. Your Pyro
									server will simply run smoother and faster.
								</div>
							</div>
						</div>
					</div>
				...
				<div className="container relative grid gap-12 pb-20 pt-24 lg:gap-20 lg:py-40">
					<div className="relative z-[14] flex max-w-[600px] flex-col items-start justify-start">
						...
						<h1 className="mb-6 max-w-4xl text-[max(48px,min(5vw,84px))] font-extrabold leading-[1.09] tracking-tighter text-white">
							<div className="flex flex-row items-center gap-4">
								Manage it all with Pyro&apos;s app
							</div>
						</h1>
						<p className="mb-6 text-xl font-medium leading-[190%] text-[#ffffff99]">
							With Pyro, you don’t hop through loops to get from paying to
							playing, it just works better. It’s like a super-app for your
							server.
						</p>
					</div>
							...
							<div className="xl:px-auto relative grid place-items-center overflow-hidden rounded-2xl border-2 border-white/10 bg-[#ffffff08] p-4 text-white sm:py-6 lg:p-4 2xl:px-6 2xl:py-6">
								<ul className="relative flex flex-col gap-4 lg:gap-8">
									<li className="leading-[190%]">
										...
										<span>
											Whether you’re a complete beginner or a seasoned pro, Pyro
									...
									<li className="leading-[190%]">
										...
										<span>
											Uncompromising speed. Optimal performance. Pyro software
									...
									<li className="leading-[190%]">
										...
										<span>
											With an in-browser IDE, file searching, CMD+K, and so much
											more.
										</span>
									</li>
									<li className="leading-[190%]">
					...
					>
						...
						<p className="mt-4 text-center text-xs font-bold opacity-50">
				...
				<div className="container relative grid gap-4 pb-20 pt-24 lg:gap-12 lg:py-40">
					...
					>
						<AccordionItem className="text-left" value="item-1">
							...
							<AccordionContent>
								Yes! You can add plugins and mods to your Minecraft server. You
								have full control over your server, so you can upload your own
								mods and plugins, and install them with ease.
							</AccordionContent>
						</AccordionItem>
						<AccordionItem className="text-left" value="item-2">
							...
							<AccordionContent>
								Yes! You can upgrade your server at any time. You can easily
								upgrade your server by selecting a new plan and paying the
								difference. Your server will be upgraded instantly.
							</AccordionContent>
						</AccordionItem>
						<AccordionItem className="text-left" value="item-3">
							<AccordionTrigger className="text-left">
								Can I switch between mod loaders? Does Pyro support Fabric,
								Forge, Neoforge?
							</AccordionTrigger>
							<AccordionContent>
								Yes! You can switch between games and software at any time. Our
								panel allows you to easily switch with just a few clicks. And
								with free backups, you can switch back to your old setup at any
								time.
							</AccordionContent>
						</AccordionItem>
						<AccordionItem className="text-left" value="item-4">
							...
							<AccordionContent>
								You get unlimited storage with your Minecraft server. You can
								upload as many worlds, mods, and plugins as you want. There are
								no limits to how much storage you can use. You only pay for the
								RAM you need.
							</AccordionContent>
						</AccordionItem>
						<AccordionItem className="text-left" value="backups">
							<AccordionTrigger className="text-left">
								Does Pyro offer backups?
							</AccordionTrigger>
							<AccordionContent>
								Yes! Pyro offers multiple free backups for all servers. You can
								create a backup of your server at any time, and restore it in
								one click. You can also schedule backups to run automatically,
						...
						<AccordionItem className="text-left" value="offsite">
							...
							<AccordionContent>
								Yes! You can store your backups offsite, like on Google Drive.
								You can set up automatic backups to run on a schedule. You can
								also download your backups at any time, so you always have a
								copy of your server.
							</AccordionContent>
						</AccordionItem>
						<AccordionItem className="text-left" value="item-5">
							<AccordionTrigger className="text-left">
								Does Pyro have player limits?
							</AccordionTrigger>
							<AccordionContent>
								No, we do not have player limits. You can invite as many friends
								as you want to play on your server. There are no extra charges
								for additional players. Ever.
							</AccordionContent>
						</AccordionItem>
						<AccordionItem className="text-left" value="item-6">
							...
							<AccordionContent>
								Yes! You can run a public server with Pyro. You can set up your
								server to be public or private, using Minecraft&apos;s whitelist
								system, or a plugin that manages it for you. You have full
								control over your server, so you can customize it to your
								liking.
							</AccordionContent>
						</AccordionItem>
						<AccordionItem className="text-left" value="item-7">
							...
							<AccordionContent>
								Yes! You can invite others to manage your server. You can create
								multiple accounts with different permissions, so you can give
								others access to your server without giving them full control.
						...
						<AccordionItem className="text-left" value="refunds">
							...
							<AccordionContent>
								Yes! We offer a 24-hour money-back guarantee. If you&apos;re not
								satisfied with your server, you can request a refund within 24
								hours of purchase. All we ask is that you let us know why
								you&apos;re not satisfied, so we can improve.
							</AccordionContent>
						</AccordionItem>
					</Accordion>
				</div>
			...
			<section className="relative z-10 flex flex-col items-center gap-8 overflow-hidden rounded-b-3xl px-4 py-48 text-center xl:px-24">
				...
				<p className="relative text-xl leading-[195%] text-[#ffffff99]">
					Contact us and get in touch with our team if you have any questions,
					or desire a custom plan.
				</p>
