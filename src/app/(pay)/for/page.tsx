		...
		<div className="relative flex flex-col items-center gap-8 py-16 text-center">
			<div className="pointer-events-none absolute inset-0 flex h-full w-full select-none justify-between opacity-10 blur-sm contrast-200">
				...
				<div className="relative h-full w-[25%]">
					<Image alt="" aria-hidden src="/img/chips-nbg.png" fill className="pointer-events-none select-none object-cover brightness-125" />
				</div>
			</div>

			<div className="container mx-auto flex w-full flex-col gap-4">
				<h1 className="mr-auto font-extrabold text-[max(24px,min(5vw,48px))] leading-[1.09] tracking-tighter">Search for games</h1>
				<section className="flex flex-col gap-2 text-left text-[#ffffffbb] text-[20px] leading-[155%]">
					<p>Unlike other hosting platforms, Pyro doesn&apos;t charge you based on what game you want to play.</p>
