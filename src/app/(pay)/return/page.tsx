		...
		return (
			<div className="flex flex-1 flex-col items-center justify-center">
				<div className="mx-auto w-full max-w-lg rounded-2xl border border-brand border-opacity-20 bg-[#111111] p-4">
					<img
						alt=""
						src="https://i.giphy.com/ISOckXUybVfQ4.webp"
					...
					<div className="mt-2">
						...
						<p className="text-center">
							Please try again or{" "}
							<PyroLink href="/discord">contact support</PyroLink> for
							assistance.
						</p>
					</div>
		...
		<>
			<div className="flex flex-1 flex-col items-center justify-center">
				<div className="mx-auto w-full max-w-lg rounded-2xl border border-brand border-opacity-20 bg-[#111111] p-4">
					...
					<p className="mt-2 text-center">
						Check your email for login details if you don&apos;t already have a
						Pyrodactyl account.
					</p>
