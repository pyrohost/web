        ...
        <main className='relative h-full w-full'>
            <section className='relative min-h-screen w-full px-16 text-center'>
                <div className='relative mx-auto flex h-full min-h-screen w-full max-w-[1620px] flex-col items-center'>
                    ...
                    />
                    <div className='z-10 mx-auto mt-[24rem] flex h-full w-full max-w-[1010px] flex-col items-center pt-20'>
                        <h1 className='text-[52px] font-extrabold leading-[98%] tracking-[-0.14rem]'>
                            {/* eslint-disable-next-line react/no-unescaped-entities */}
                            Pyro's mission is to power{' '}
                            <span
                        ...
                        <p className='mt-10 text-[22px] font-normal leading-[155%] text-[#ffffff99]'>
                            {/* eslint-disable-next-line react/no-unescaped-entities */}
                            We're a passionate, tight-knit team obsessed with every step of the hosting process. We want
                            to empower anyone to play their favorite games with friends.
                        </p>
                        {/* <Image
              className="mt-10"
