        ...
        <div className='mx-auto flex w-full max-w-[1620px] flex-col'>
            <div className='z-10 mx-auto flex w-full max-w-[73ch] flex-col px-6 py-16 lg:px-12 lg:py-60'>
                ...
                <article className='mt-8 flex flex-col gap-4 leading-[155%]'>
                    <div className=''>
                        "Pyro", "we" or "us" refers to Pyro Host Inc. "You", "your", or "user" refers to you, the
                        individual accessing our website. "Services" refers to services, apps, websites, and other
                        products operated by Pyro. By using or accessing Pyro's website, you agree to Pyro's use of
                        Cookies as outlined below. This Cookie Policy is part of our Privacy Policy and explains how we
                        use cookies and similar technologies to recognize you when you visit our website. It explains
                        what these technologies are and why we use them, as well as your rights to control our use of
                        them.
                    </div>
                    <div>
                        Cookies are small, text-only pieces of data that are stored on an individual's device. Cookies
                        allow a website to remember your actions or preferences over time. Cookies are used to improve
                        the user experience by enabling a website to remember you, either for the duration of your visit
                    ...
                    <div>
                        ...
                        to create reports about the use of our website. As this information is processed exclusively by
                    ...
                    <div>
                        Google Analytics may set cookies on your device or read cookies that are already there to
                        identify you. If users wish to opt-out of Google Analytics, they can use the Google Analytics
                        opt-out browser add-on. For more information, please visit the{' '}
                        <a
                            className='underline'
                    ...
                    <div>
                        Pyro does not sell, rent, or otherwise share any information gathered from cookies with any
                        third party. Pyro cannot reasonably use Google Analytics identifiers to personally identify you
                        or any other user.
                    </div>
                </article>
            </div>
