        ...
        <div className="mx-auto flex w-full max-w-[1620px] flex-col">
          <div className="z-10 mx-auto flex w-full max-w-[73ch] flex-col pt-60">
            ...
            <article className="mt-8 flex flex-col gap-4 leading-[155%]">
              <div>
                Johnathan Bell, DBA Pyro operates the website pyro.host and
                certain services under the name "pyro.host" and is referred to
                as "Pyro" in this Privacy Policy. This Privacy Policy is
