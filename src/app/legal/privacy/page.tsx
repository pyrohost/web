        ...
        <div className="mx-auto flex w-full max-w-[1620px] flex-col">
          <div className="z-10 mx-auto flex w-full max-w-[73ch] flex-col pt-60">
            ...
            <article className="mt-8 flex flex-col gap-4 leading-[155%]">
              <div>
                Pyro Hosting, LLC DBA pyro.host operates the website pyro.host
                and certain services under the name "pyro.host" and is referred
                to as "Pyro" in this Privacy Policy. This Privacy Policy is
                designed to help you understand how we collect, use, and share
                your information, and to help you understand and exercise your
                privacy rights.
              </div>
              <div>
              ...
              <div>
                While you use our Services, we collect only a minimal amount of
                data needed to provide you with our Services. However, we may
                collect additional types of information when you visit our
                website or communicate with us through other means, such as
                email or social media. We explain the types of information we
                collect below.
              </div>
              <strong>A. Information You Provide to Us Directly</strong>
              <div>
                We may collect the following types of information that you
                provide to us directly.
              </div>
              <ul className="list-disc">
                <li>
                  <strong>Account Creation.</strong> We may collect information
                  when you create an account with us, such as your email
                  address, username, and password. Note that although you
                  provide login credentials to access our services, we do not
                  store your plain-text password on our servers.
                </li>
                <li>
                ...
                <li>
                  ...
                  information when you communicate with us, such as when you
                  request customer or technical support, request information
                  about our Services, or otherwise communicate with us.
                </li>
                <li>
                  <strong>Surveys.</strong> We may contact you to participate in
                  surveys about our Services, and some of these surveys may ask
                  you to provide certain information about yourself.
                </li>
              </ul>
              <br></br>
              ...
              <div>
                ...
                our website or use our Services to provide and measure our
                Services for security, performance, and fraud prevention
                purposes:
              </div>
              <ul className="list-disc">
                <li>
                  <strong>Automatic Data Collection.</strong> In order to
                  protect you and our Services, we may automatically collect
                  certain information when you visit our website or use our
                  Services, such as your Internet Protocol (IP) address
                  (temporarily), device information, and authentication cookies.
                </li>
                <li>
                  <strong>Cookies and Other Technologies.</strong> Please see
                  our{" "}
                ...
                <li>
                  ...
                  third-party tools, including those provided by Google, to
                  better understand how individuals use our Services. These
                  tools are only used on Pyro's marketing sites ("pyro.host")
                  and not Pyro services ("panel.pyro.host", "vps.panel.host").
                </li>
              </ul>
              <br></br>
              ...
              <div>
                ...
                <ul className="list-disc">
                  ...
                  <li>
                    Comminicating with you about your account, purchases, or use
                    of our Services, including any changes to our terms or
                    policies
                  </li>
                </ul>
                <br></br>
                ...
                <ul className="list-disc">
                  ...
                  <li>
                    Measuring and analyzing interest and engagement in our
                    Services
                  </li>
                  <li>
                    Short-term, transient use, such as customization of content
                  ...
                  <li>
                    Verifying your identity and preventing fraud, including
                    requests to exercise your privacy rights under this Privacy
                    Policy
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    Acceptable Use Policy, Terms of Service, and this Privacy
                    Policy
                  </li>
                  <li>
                ...
                We may use your information for other purposes as requested by
                you or as permitted by applicable law.
                <ul className="list-disc">
                  <li>
                    <strong>Consent.</strong> We may use your information for
              ...
              <div>
                We disclose your information to third parties for limited
                business purposes, including to provide payments processing, to
                provide customer support, to protect us or others, or in the
                event of a major business transaction such as a merger, sale,
                asset transfer, or in the unlikely event of bankruptcy, as
                described below.
              </div>
              ...
              <ul className="list-disc">
                <li>
                  ...
                  third-party service providers or business partners. However,
                  we may share your information with third-party service
                  providers and business partners that help us to operate,
                ...
                <li>
                  ...
                  in good faith, believe doing so is required or appropriate to:
                  comply with law enforcement or national security requests and
                  legal process, such as a court order or subpoena; protect
                  your, our, or others' rights, property, or safety; enforce our
                  policies or contracts; collect amounts owed to us; or assist
              ...
              <strong>
                Disclosures in the Event of Merger, Sale, or Other Asset
                Transfers
              </strong>
              <div>
                ...
                transaction as permitted by law and/or contract. We cannot
                control how such entities may use or disclose such information.
              </div>
              <br></br>
              ...
              <div>
                ...
                well. By using our Services or providing information to us, you
                ...
                use of our Services. If we are required to notify you of a
                security incident, we may attempt to notify you electronically
                by posting a notice on our Services, by mail or by sending an
                email to you.
              </div>
              <br></br>
              ...
              <div>
                ...
                children under the age of 18. If we learn that we have collected
                personal information of a child under the age of 18, we will
                take steps to delete such information from our Services as soon
                as possible.
              </div>
              <br></br>
              ...
              <div>
                ...
                at the bottom of our marketing messages. Please note that you
                cannot opt out of non-promotional emails, such as those about
                your account, transactions, servicing, or Pyro's ongoing
                business relations.
              </div>
              <div>
              ...
              <div>
                ...
                browser setting that users can set in certain web browsers.
                Please note that we do not respond to or honor DNT signals or
                similar mechanisms transmitted by web browsers. Pyro does not
                use cross-site tracking or targeted advertising.
              </div>
              <div>
                <strong>Access to Your Information. </strong> You may request
                access to your personal information by using the email address
                listed in the "Contact Us" section below. We will respond to
              ...
              <div>
                ...
                the updated Privacy Policy if you continue to use our Services
